    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden flex flex-col max-h-[90vh]">
        <div className="bg-[var(--bg-primary)] p-6 border-b border-[var(--border)] relative flex-shrink-0">
          ...
          <h1 className="text-2xl font-serif font-bold text-[var(--text-primary)]">Marcus Aurelius</h1>
        ...
        <div className="p-6 overflow-y-auto custom-scrollbar space-y-6 flex-1">
          <section className="prose prose-sm prose-invert max-w-none">
            <h3 className="text-[var(--text-primary)] font-serif font-bold text-lg mb-2">The Philosopher King</h3>
          ...
          <section className="bg-[var(--bg-primary)] p-4 rounded-lg border border-[var(--border)]">
            <h4 className="text-xs font-bold uppercase text-[var(--accent)] mb-2 tracking-wide">Core Principles</h4>
